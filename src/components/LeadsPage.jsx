        ...
        <div className="p-8">
            <div className="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p className="text-sm text-gray-500">View and manage all your collected hospital leads</p>
                </div>
                <button
                    onClick={fetchLeads}
                                ...
                                {leads.map((lead, index) => (
                                    <tr key={lead._id || index} className="hover:bg-gray-50/50 transition-colors group">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-[11px] text-gray-500">Hospital/Medical Center</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-4">
                                        ...
                                        <td className="px-6 py-4">
                                            ...
                                            <div className="text-[11px] text-gray-400">{new Date(lead.createdAt).toLocaleTimeString()}</div>
                                        </td>
