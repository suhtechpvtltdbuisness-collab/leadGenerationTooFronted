                ...
                <div className="flex-1 overflow-auto p-6">
                    {isLoading && (
                        <div className="flex flex-col items-center justify-center py-20 gap-4">
                            ...
                            <p className="text-gray-500 font-medium">Scraping live data from Google Maps...</p>
                        </div>
                    )}
                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="bg-gray-50 border-b border-gray-200">
                                        ...
                                        <th className="px-6 py-4 text-sm font-semibold text-gray-700">ADDRESS</th>
                                ...
                                <tbody className="divide-y divide-gray-100">
                                    {results.map((hospital, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-600 truncate max-w-[200px]" title={hospital.address}>
                                                {hospital.address}
                                            </td>
                                            <td className="px-6 py-4 text-sm text-gray-600 font-medium">{hospital.phone}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
                    ...
                    {!isLoading && query.length >= 2 && results.length === 0 && (
                        <div className="flex flex-col items-center justify-center py-20 text-center">
                            ...
                            <p className="text-gray-500 max-w-xs mx-auto">
                                We couldn't find any hospitals matching "{query}". Try a different search term.
                            </p>
                        </div>
                    )}
                    ...
                    {!isLoading && query.length < 2 && (
                        <div className="flex flex-col items-center justify-center py-20 text-center">
                            ...
                            <h3 className="text-lg font-semibold text-gray-900 font-display">Start searching</h3>
